...
export const generateThemeConfig = (factor, baseShade) => {
  return {
    ...
    colors: {
      ...
      successBackground: factor > 0 ? '#d4edda' : '#155724',
      danger: colors.red,
      dangerHover: darken(0.1, colors.red),
      warning: colors.warning,
      warningBackground: factor > 0 ? '#fff3cd' : '#856404',
      error: colors.red,
      errorBackground: factor > 0 ? '#f8d7da' : '#721c24',
      info: colors.info,
      text: getShade(0.9, baseShade, factor),
      textSecondary: getShade(0.6, baseShade, factor),
      background: baseShade,
      backgroundSecondary: getShade(0.03, baseShade, factor),
      ...
      surfaceHover: getShade(0.04, baseShade, factor),
